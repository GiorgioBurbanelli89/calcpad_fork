...
// Copiar MatrixXd a COMPLEXARRAY
...
// Copiar COMPLEXARRAY a MatrixXd
...
// Copiar VectorXd a COMPLEXARRAY (columna)
...
// ============================================
// FUNCION 1: Matriz de rigidez de viga 2D
// fem_beam_K(E, A, I, L) -> matriz 6x6
// ============================================
                     ...
                     LPCCOMPLEXSCALAR pL)
{
    ...
    // Construir matriz de rigidez local
...
FUNCTIONINFO fi_FemBeamK = {
    (char*)"fem_beam_K",
    (char*)"E,A,I,L",
    (char*)"Matriz de rigidez 6x6 para viga 2D (ux,uy,rz por nodo)",
...
// ============================================
// FUNCION 2: Resolver sistema K*U = F
// fem_solve(K, F, supports) -> U
// ============================================
...
FUNCTIONINFO fi_FemSolve = {
    (char*)"fem_solve",
    (char*)"K,F,supports",
    (char*)"Resuelve K*U=F. supports: vector 0/1 para DOFs fijos",
...
// ============================================
// FUNCION 3: Deflexion cantilever analitica
// cantilever_defl(P, L, E, I) -> deflexion
// ============================================
...
FUNCTIONINFO fi_CantileverDefl = {
    ...
    (char*)"P,L,E,I",
    (char*)"Deflexion analitica cantilever: P*L^3/(3*E*I)",
...
// ============================================
// FUNCION 4: Matriz de rigidez Frame 3D (12x12)
// fem_frame3d_K(E, G, A, Iy, Iz, J, L) -> matriz 12x12
// ============================================
...
FUNCTIONINFO fi_FemFrame3dK = {
    ...
    (char*)"Matriz rigidez 12x12 frame 3D (6 DOF/nodo)",
...
// ============================================
// Punto de entrada DLL (estilo Mathcad oficial)
// ============================================
