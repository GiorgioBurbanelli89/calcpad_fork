...
namespace Calcpad.Common.Plugins
{
    ...
    /// </summary>
    public interface ICalcpadEngine
    {
        ...
        /// <summary>Traduce expresión a sintaxis Calcpad (para traductores)</summary>
        string TranslateToCalcpad(string expression);
    ...
    /// </summary>
    public interface ISymbolicEngine : ICalcpadEngine
    {
    ...
    /// </summary>
    public interface ITranslatorEngine : ICalcpadEngine
    {
    ...
    /// </summary>
    public abstract class CalcpadEngineBase : ICalcpadEngine
    {
        ...
        public virtual string TranslateToCalcpad(string expression)
        {
    ...
    /// </summary>
    public abstract class TranslatorEngineBase : CalcpadEngineBase, ITranslatorEngine
    {
        ...
        public override double EvaluateNumeric(string expression, IDictionary<string, double> variables = null)
        {
            ...
            throw new NotSupportedException("Translator engines do not evaluate directly. Use TranslateToCalcpad.");
        }

        public override string TranslateToCalcpad(string expression)
        {
