...
{
    /// <summary>
    /// Parser que convierte sintaxis Mathcad Prime a sintaxis Calcpad
    /// </summary>
    public class MathcadParser : BaseExpressionParser
    {
        ...
        public override string Translate(string expression)
        {
            ...
            // 2. Convertir notación de vectores/matrices de Mathcad a Calcpad
            ...
            // d/dx(f) en Mathcad -> diff(f, x) en Calcpad
            result = ConvertDerivativeNotation(result);

            // 4. Convertir rangos de Mathcad: x := 0, 0.1 .. 10 -> similar a Calcpad
        ...
        /// <summary>
        /// Convierte notación de derivadas de Mathcad a Calcpad
        /// </summary>
        private string ConvertDerivativeNotation(string expression)
        {
            // Mathcad: d/dx(f(x)) -> Calcpad: diff(f(x), x)
        ...
        /// <summary>
        /// Traduce definición de función de Mathcad a Calcpad
        /// Mathcad: f(x) := x^2 + 1
        /// Calcpad: f(x) = x^2 + 1
        /// </summary>
        ...
        /// <summary>
        /// Convierte matrices de Mathcad a sintaxis Calcpad
        ...
        public string TranslateMatrix(string mathcadMatrix)
        {
            ...
            // Por ahora, retornar tal cual (Calcpad y Mathcad son bastante similares)
            return mathcadMatrix;
        }

        /// <summary>
        /// Convierte unidades de Mathcad a Calcpad
        /// Mathcad: 5 m, Calcpad: 5'm
        /// </summary>
