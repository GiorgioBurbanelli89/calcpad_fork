...
namespace Calcpad.Common.ExpressionParsers
{
    ...
    {
        /// <summary>Delimitador para comentarios de línea (ej: ' para Calcpad, % para LaTeX, # para Python)</summary>
        ...
        /// <summary>Delimitador para strings (ej: " para Calcpad, ' para Python)</summary>
        ...
        /// <summary>Delimitador para HTML/output (ej: '<> en Calcpad)</summary>
        ...
        /// <summary>Símbolo para variables especiales/substitución (ej: $ en Calcpad)</summary>
        public string VariablePrefix { get; set; } = "$";

        /// <summary>Símbolo para directivas/keywords (ej: # en Calcpad, @ en C#)</summary>
        public string DirectivePrefix { get; set; } = "#";

        /// <summary>Operador de asignación (ej: = en Calcpad, := en Mathcad)</summary>
        public string Assignment { get; set; } = "=";

        /// <summary>Operador de evaluación/mostrar resultado (ej: = ? en Calcpad)</summary>
        public string Evaluation { get; set; } = "= ?";

        /// <summary>Operador de potencia (ej: ^ en Calcpad, ** en Python)</summary>
        public string Power { get; set; } = "^";

        /// <summary>Operador de multiplicación (ej: * en Calcpad, · en Mathcad)</summary>
        public string Multiply { get; set; } = "*";

        /// <summary>Operador de división (ej: / en Calcpad, ÷ en Mathcad)</summary>
        public string Divide { get; set; } = "/";

        /// <summary>Separador de argumentos (ej: ; en Calcpad, , en Python)</summary>
        public string ArgumentSeparator { get; set; } = ";";

        /// <summary>Separador de elementos en matriz fila (ej: , en Calcpad)</summary>
        public string MatrixRowSeparator { get; set; } = ",";

        /// <summary>Separador de elementos en matriz columna (ej: ; en Calcpad)</summary>
        public string MatrixColSeparator { get; set; } = ";";

        /// <summary>Separador de filas en matriz (ej: | en Calcpad)</summary>
        public string MatrixLineSeparator { get; set; } = "|";

        /// <summary>Prefijo para unidades (ej: ' en Calcpad, * en otros)</summary>
        public string UnitPrefix { get; set; } = "'";

        /// <summary>Delimitador para inicio de función especial (ej: $Root{ en Calcpad)</summary>
        ...
        /// <summary>Estilo de bloques: "indent" (Python), "braces" (C), "keywords" (Calcpad)</summary>
        public string BlockStyle { get; set; } = "keywords";

        /// <summary>
        /// Crea una configuración por defecto para Calcpad nativo
        /// </summary>
        public static ParserSyntaxConfig CalcpadDefault()
        {
    ...
    public class ConfigurableParser : BaseExpressionParser
    {
        ...
        public ConfigurableParser(string name, string directive, ParserSyntaxConfig config)
        {
            ...
            _config = config ?? ParserSyntaxConfig.CalcpadDefault();
        }
