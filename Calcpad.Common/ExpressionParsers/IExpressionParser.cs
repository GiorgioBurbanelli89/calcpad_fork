...
namespace Calcpad.Common.ExpressionParsers
{
    ...
    public interface IExpressionParser
    {
        ...
        /// <summary>
        /// Traduce una expresión de la sintaxis externa a sintaxis Calcpad
        /// </summary>
        /// <param name="expression">Expresión en sintaxis externa</param>
        /// <returns>Expresión traducida a Calcpad</returns>
    ...
    {
        /// <summary>Traduce a sintaxis Calcpad</summary>
        Translate,
