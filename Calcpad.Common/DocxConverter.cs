// DocxConverter.cs - Conversor de Word (.docx) a Calcpad (.cpd)
// Estrategia mejorada: DOCX → HTML (DocxReader) → CPD (HtmlToCalcpadParser)
// Usa el DocxReader existente de Calcpad.OpenXml para una conversión más robusta
...
{
    /// <summary>
    /// Conversor de archivos Word (.docx) a Calcpad (.cpd)
    ...
    public class DocxConverter
    {
        ...
        public string Convert(string docxPath)
        {
            ...
            try
            {
                ...
                // Usar DocxReader (de Calcpad.OpenXml) si está disponible, sino leer directamente
                ...
                // PASO 3: Convertir contenido a formato Calcpad
                ConvertContentToCalcpad(content);
        ...
        /// <summary>
        /// Convierte el contenido extraído a formato Calcpad
        /// </summary>
        private void ConvertContentToCalcpad(string content)
        {
            ...
            foreach (var line in lines)
            {
                ...
                {
                    // Encabezado de sección (usa comillas en Calcpad)
                ...
                {
                    // Ecuación matemática
                    var equation = ConvertToCalcpadEquation(trimmedLine);
                    _output.AppendLine(equation);
                }
                else if (IsDefinition(trimmedLine))
                {
                    // Definición de variable (contiene =)
                    var definition = ConvertToCalcpadDefinition(trimmedLine);
        ...
        /// <summary>
        /// Convierte una línea a ecuación Calcpad
        /// </summary>
        private string ConvertToCalcpadEquation(string line)
        {
        ...
        /// <summary>
        /// Convierte una línea de definición a formato Calcpad
        /// </summary>
        private string ConvertToCalcpadDefinition(string line)
        {
            ...
            if (unitMatch.Success)
            {
                ...
                // Convertir unidad a formato Calcpad
                var calcpadUnit = ConvertUnitToCalcpad(unit);
        ...
        /// </summary>
        private string ConvertUnitToCalcpad(string unit)
        {
