...
{
    /// <summary>
    /// Provides compression and decompression utilities for Calcpad files (.cpdz)
    /// Unified from Calcpad.Wpf and Calcpad.Cli implementations
    /// </summary>
    public static class Zip
    {
        ...
        /// Callers should use .EnumerateLines() from Calcpad.Core.ExtensionMethods for line iteration
        /// </summary>
