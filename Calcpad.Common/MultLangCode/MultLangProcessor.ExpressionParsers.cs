...
namespace Calcpad.Common.MultLangCode
{
    ...
    public partial class MultLangProcessor
    {
        ...
        /// y lo traduce a sintaxis Calcpad
        /// </summary>
        ...
        /// <returns>Contenido traducido a sintaxis Calcpad</returns>
        private string ProcessExpressionParserBlock(string directive, string content)
        {
            try
            {
                ...
                // Si el parser está en modo traducción o híbrido, convertir a Calcpad
        ...
        /// </summary>
        /// <param name="code">Código Calcpad con posibles bloques de expresiones</param>
