# -*- coding: utf-8 -*-
"""
Test Shell - CON SHELL-THICK (TIPO 2)
ShellType 2 = Shell-Thick (Mindlin-Reissner, CON FLEXION Y MEMBRANA)
"""
import comtypes.client

print("="*70)
print("TEST SHELL - SHELL-THICK (TIPO 2 - MINDLIN)")
print("="*70)
...
try:
    ...
    print("\n[4] Definiendo propiedad SHELL-THICK...")
    # SetShell_1(Name, ShellType, IncludeDrillingDOF, MatProp, MatAng, Thickness, Bending, Color, Notes, GUID)
    # ShellType 2 = Shell-Thick (Mindlin-Reissner: FLEXION + MEMBRANA)
    ret = SapModel.PropArea.SetShell_1('SHELL', 2, False, 'CONC', 0, 0.2, 0.2, -1, "", "")
    print(f"    [OK] SHELL (Shell-Thick tipo 2, t=0.2m, ret={ret})")
    ...
    print("\n[6] Creando area...")
    ret_area = SapModel.AreaObj.AddByCoord(4, x_coords, y_coords, z_coords, "A1", "SHELL", "A1")
    ...
    # Save
    ModelPath = R'C:\Users\j-b-j\Documents\Calcpad-7.5.7\TEST_SHELL_THICK.sdb'
    print(f"\n[10] Guardando...")
    ...
    if NumberResults > 0 and (max_m11 > 0 or max_m22 > 0):
        print("EXITO TOTAL - RESULTADOS DE SHELL CON MOMENTOS")
