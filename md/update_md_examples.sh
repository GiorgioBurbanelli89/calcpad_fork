...
languages=(
    ...
    "lua" "perl" "r" "matlab" "octave" "bash" "cmd" "powershell"
    "julia" "fortran" "c" "html" "xaml" "wpf" "avalonia" "qt" "gtk"
    "opensees"
)
...
while IFS= read -r file; do
    if [ -f "$file" ]; then
        ...
        for lang in "${languages[@]}"; do
            ...
            if grep -q "^#end ${lang}" "$file" 2>/dev/null; then
...
echo ""
echo "Total archivos modificados en md/: $count"
