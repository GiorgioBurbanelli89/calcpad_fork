...
Source: "CalcpadDebugger\bin\Release\net10.0-windows\Calcpad.Core.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "CalcpadDebugger\bin\Release\net10.0-windows\Calcpad.Common.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "CalcpadDebugger\bin\Release\net10.0-windows\Calcpad.OpenXml.dll"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "Calcpad.Core\*.cs"; DestDir: "{app}\Source\Calcpad.Core"; Flags: ignoreversion recursesubdirs
Source: "Calcpad.Common\*.cs"; DestDir: "{app}\Source\Calcpad.Common"; Flags: ignoreversion recursesubdirs
