...
namespace Calcpad.Core
{
    internal class ComplexCalculator : Calculator
    {
        ...
        // TEST FUNCTION: suma(x) = x + 1 - para verificar sincronización CLI/WPF
        private static ComplexValue Suma(in ComplexValue value) => new(value.A + 1, value.B, value.Units);
