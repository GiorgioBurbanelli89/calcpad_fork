...
{
    /// <summary>
    /// Visor de hojas de calculo Excel (.xlsx) integrado en Calcpad
    /// </summary>
...
";
        ...
        private async System.Threading.Tasks.Task ImportSelectedData(ImportFormat format)
        {
            ...
            try
            {
                ...
                ImportToCalcpad?.Invoke(this, new ExcelImportEventArgs
                {
                    Content = calcpadCode,
                ...
                StatusText.Text = "Datos importados a Calcpad";
            }
            catch (Exception ex)
            {
    ...
    /// <summary>
    /// Formato de importacion a Calcpad
    /// </summary>
    ...
    /// <summary>
    /// Argumentos para el evento ImportToCalcpad de Excel
    /// </summary>
