...
namespace Calcpad.Wpf.MathEditor
{
    ...
    {
        /// <summary>
        /// Analiza código Calcpad y muestra el formato de cada carácter
        /// </summary>
        public static void AnalyzeAndPrint(string code)
        {
            ...
            for (int lineNum = 0; lineNum < lines.Length; lineNum++)
            {
                ...
                // Mostrar cómo se vería en HTML (similar al output de Calcpad)
                Console.WriteLine();
        ...
        /// <summary>
        /// Genera el HTML esperado según el template de Calcpad
        /// </summary>
