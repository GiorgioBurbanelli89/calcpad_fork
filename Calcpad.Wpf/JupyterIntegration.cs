...
{
    /// <summary>
    /// Integración de Jupyter Notebook en Calcpad
    ...
    public class JupyterIntegration
    {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var result = MessageBox.Show(
                        ...
                        "Esto permitirá ejecutar código Python dentro de Calcpad.",
                        "Jupyter Integration",
        ...
        {
            string instructions = @"Para usar Jupyter en Calcpad, instala Python + Jupyter:
...
Después de instalar, reinicia Calcpad.";
