...
{
    /// <summary>
    /// Visor y editor de documentos Word (.docx) integrado en Calcpad
    /// </summary>
...
{editScript}
        ...
        private async void ImportButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    ImportToCalcpad?.Invoke(this, new ImportToCalcpadEventArgs
                    {
                        Content = text,
                        SourceFile = _currentFilePath
                    });

                    StatusText.Text = "Contenido importado a Calcpad";
                }
            }
            catch (Exception ex)
            {
    ...
    /// <summary>
    /// Argumentos para el evento ImportToCalcpad
    /// </summary>
    public class ImportToCalcpadEventArgs : EventArgs
    {
