...
{
    /// <summary>
    /// Sistema de telemetría en tiempo real para Calcpad WPF
    /// Registra eventos, errores y métricas de rendimiento
    /// </summary>
    public static class CalcpadTelemetry
    {
        ...
        {
            // Crear archivo de telemetría en %TEMP%\Calcpad
            var tempDir = Path.Combine(Path.GetTempPath(), "Calcpad");
