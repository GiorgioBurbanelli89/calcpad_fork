...
// Compilar con: csc /r:Calcpad.Common.dll test_chartcomponent_conversion.cs

using System;
using System.IO;
using Calcpad.Common;

class TestChartComponentConversion
{
    static void Main(string[] args)
    {
        ...
        try
        {
            ...
            // Guardar resultado
            string outputPath = Path.ChangeExtension(mcdxPath, ".cpd");
            File.WriteAllText(outputPath, result);
            Console.WriteLine($"Resultado guardado en: {outputPath}");
            Console.WriteLine();

            // Mostrar fragmento del resultado (primeras 100 líneas)
